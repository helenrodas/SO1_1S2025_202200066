...
plt.subplot(2, 1, 1)
plt.plot(timestamps, memory_usage, marker='o', label='Uso de Memoria (%)', color='blue')
...
plt.subplot(2, 1, 2)
plt.plot(timestamps, cpu_usage, marker='o', label='Uso de CPU (%)', color='orange')
...
plt.tight_layout()
plt.show()
plt.savefig('/home/helen/Programacion/sopes/SO1_1S2025_202200066/Proyecto1/Imagenes/container_metrics.png')

...
const (
	TweetService_PublishTweet_FullMethodName = "/tweet.TweetService/PublishTweet"
)
...
type TweetServiceClient interface {
	PublishTweet(ctx context.Context, in *TweetRequest, opts ...grpc.CallOption) (*TweetResponse, error)
}
...
func (c *tweetServiceClient) PublishTweet(ctx context.Context, in *TweetRequest, opts ...grpc.CallOption) (*TweetResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TweetResponse)
	err := c.cc.Invoke(ctx, TweetService_PublishTweet_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TweetServiceServer interface {
	PublishTweet(context.Context, *TweetRequest) (*TweetResponse, error)
...
func (UnimplementedTweetServiceServer) PublishTweet(context.Context, *TweetRequest) (*TweetResponse, error) {
...
func _TweetService_PublishTweet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TweetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TweetServiceServer).PublishTweet(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TweetService_PublishTweet_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TweetServiceServer).PublishTweet(ctx, req.(*TweetRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _TweetService_PublishTweet_Handler,
		},
	},
